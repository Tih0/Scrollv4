...
from config import TOKEN_USDC, useProxy, proxygas, maxGas
import time
...
def chek_gas_eth(max_gas_):
    ...
    try:
        eth_w3 = Web3(Web3.HTTPProvider(endpoint_uri=RPC_ETH,
                                         request_kwargs={'proxies': {'http': proxygas, 'https': proxygas}}))
        while True:
